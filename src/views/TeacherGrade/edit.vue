<template>
	<div class="index_main">
		<div class="main_btn_left">
			...
			<div class="index_main_title">年级编辑</div>
		</div>
...
<script>
	export default {
	    ...
	    methods: {
	      submit:function(){
	      	var _this = this;
	      	this.$post(this.ROOT_URL + 'Admin/teacher_grade/edit/' + this.$route.params.id ,{name:this.name}).then(function(res){
	      		_this.$message({
		          message: '恭喜你，修改成功！',
		          type: 'success'
		        });
	    ...
	    created:function(){
	    	var _this = this;
	    	this.$get(this.ROOT_URL + "Admin/teacher_grade/edit/"+this.$route.params.id).then(function(res){
