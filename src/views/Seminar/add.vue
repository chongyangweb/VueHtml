<template>
	<div class="index_main">
		<div class="main_btn_left">
			...
			<div class="index_main_title">专题添加</div>
		</div>
		...
		<div class="main_content">
			...
			<el-row :gutter="20">
				...
				<el-upload
				  class="upload-demo"
				  :action="ROOT_URL + 'Admin/product/thumb'"
...
<script>
	...
	export default {
	    ...
	    methods: {
	      submit:function(){
	      	var _this = this;
	      	this.$post(this.ROOT_URL + 'Admin/seminar/add',{title:this.title,content:this.content,is_hot:this.is_hot,is_top:this.is_top,thumb:this.thumb,cid:this.cid,author:this.author}).then(function(res){
	      		_this.$message({
		          message: '恭喜你，添加成功！',
		          type: 'success'
		        });
	    ...
	    mounted:function(){
		    ...
		    var _this = this;
	    	_this.$get(_this.ROOT_URL + "Admin/seminar/add").then(function(res){
