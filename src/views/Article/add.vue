<template>
	<div class="index_main">
		<div class="main_btn_left">
			...
			<div class="index_main_title">文章添加</div>
		</div>
...
<script>
	...
	export default {
	    ...
	    methods: {
	      submit:function(){
	      	var _this = this;
	      	this.$post(this.ROOT_URL + 'Admin/article/add',{title:this.title,content:this.content,is_hot:this.is_hot,is_top:this.is_top,thumb:this.thumb,cid:this.cid,author:this.author}).then(function(res){
	      		_this.$message({
		          message: '恭喜你，添加成功！',
		          type: 'success'
		        });
