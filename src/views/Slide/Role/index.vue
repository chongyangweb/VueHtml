<template>
	<div class="index_main">
		<div class="main_btn_left">
			<router-link class="admin_fff_btn" :to="{name:'role_add'}"><el-button type="primary" icon="el-icon-plus">添加</el-button></router-link>
		...
		<div class="unline"></div>
			...
			<el-table ref="multipleTable" :data="lists" tooltip-effect="dark" size="medium" style="width: 100%" @selection-change="changeFun">‘
				...
				<router-link :to="{name:'role_edit',params:{id:scope.row.id}}"><el-button plain icon="el-icon-edit" >编辑</el-button></router-link>
				</template>
				</el-table-column>
...
<script>
	export default {
	    ...
	    methods: {
	      ...
	      search:function(){
	      	var _this = this;
	    	_this.$post(this.ROOT_URL + 'Admin/role/index',{limit:this.page.limit,page:this.page.page,name:this.name}).then(function(res){
	      ...
	      getList:function(){
	      	var _this = this;
	    	_this.$post(this.ROOT_URL + 'Admin/role/index',{limit:this.page.limit,page:this.page.page}).then(function(res){
	    		_this.lists = res.data;
	    		_this.page = res.page;
	    	});
	      }
