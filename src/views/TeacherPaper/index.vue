<template>
	<div class="index_main">
		<div class="main_btn_left">
			<router-link class="admin_fff_btn" :to="{name:'teacher_paper_add'}"><el-button type="primary" icon="el-icon-plus">添加</el-button></router-link>
	...
	export default {
	    ...
	    methods: {
	      ...
	      del:function(){
	      	...
	      	this.$post(this.ROOT_URL + 'Admin/teacher_paper/del',{id:this.ids}).then(function(res){
	      		_this.$message({
		          message: '恭喜你，删除成功！',
		          type: 'success'
		        });
	      ...
	      search:function(){
	      	var _this = this;
	    	_this.$post(this.ROOT_URL + 'Admin/teacher_paper/index',{limit:this.page.limit,page:this.page.page,name:this.name}).then(function(res){
	      ...
	      getList:function(){
	      	var _this = this;
	    	_this.$post(this.ROOT_URL + 'Admin/teacher_paper/index',{limit:this.page.limit,page:this.page.page}).then(function(res){
	    		_this.lists = res.data;
	    		_this.page = res.page;
	    	});
	      }
