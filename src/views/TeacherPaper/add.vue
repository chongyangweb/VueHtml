<template>
	<div class="index_main">
		<div class="main_btn_left">
			...
			<div class="index_main_title">试卷添加</div>
		</div>
...
<script>
	export default {
	    ...
	    methods: {
	      submit:function(){
	      	var _this = this;
	      	this.$post(this.ROOT_URL + 'Admin/teacher_paper/add',{name:this.name}).then(function(res){
	      		_this.$message({
		          message: '恭喜你，添加成功！',
		          type: 'success'
		        });
	    ...
	    created:function(){
	    	var _this = this;
	    	_this.$get(_this.ROOT_URL + "Admin/teacher_paper/add").then(function(res){
	    		_this.parent = res;
	    	});
	    }
	  };
