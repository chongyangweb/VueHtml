<template>
	<div class="index_main">
		<div class="main_btn_left">
			...
			<div class="index_main_title">试卷编辑</div>
		</div>
		...
		<div class="main_content">
			<el-row :gutter="20">
				<el-col :span="3"><div class="input_lable">试卷名</div></el-col>
...
<script>
	export default {
	    ...
	    methods: {
	      submit:function(){
	      	var _this = this;
	      	this.$post(this.ROOT_URL + 'Admin/teacher_paper/edit/' + this.$route.params.id ,{name:this.name}).then(function(res){
	      		_this.$message({
		          message: '恭喜你，修改成功！',
		          type: 'success'
		        });
	    ...
	    created:function(){
	    	var _this = this;
	    	this.$get(this.ROOT_URL + "Admin/teacher_paper/edit/"+this.$route.params.id).then(function(res){
